...
<div id="container">   
   ...
   <section>
   	<article>
   		...
   		<p>현재 블로그는 Desktop에만 맞추어서 제작이 되어서 핸드폰으로 보시면 레이아웃이 깨집니다. 추후에 모바일용 UI도 제작할 예정입니다. </p>
   		<p>HTML5로 제작되었기 때문에 브라우저 이용시 <strong><ins>IE 11, Chrome 35, Firefox 30</strong></ins>에서 가장 최적화된 페이지를 보실 수 있습니다. <br />
